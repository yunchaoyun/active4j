...
import com.active4j.service.func.timer.util.QuartzJobDisallowConcurrentExecution;
import com.active4j.service.func.timer.util.QuartzJobExecution;
...
public class QuartzService {
    ...
    public boolean addJob(QuartzJobEntity quartzJob) {
    	try {
        	...
        	//放入参数，以便运行方法是获取
        	jobDetail.getJobDataMap().put(GlobalConstant.QUARTZ_JOB_PARAM_KEY, quartzJob);
    ...
    public boolean runAJobNow(QuartzJobEntity quartzJob) {
        try {
            ...
            dataMap.put(GlobalConstant.QUARTZ_JOB_PARAM_KEY, quartzJob);
